...
TRAIN_DATA = list(read_json_file(os.path.join("./", 'Spacy_ner_EntityRecognizer_training-data.json')))
n_iter=10
...
# Expected output
# Entities [('Oct. 19', 'DATE'), ('The Misanthrope', 'WORK_OF_ART'),
#     ('Chicago', 'GPE'), ('Goodman Theatre', 'FAC'), ('Revitalized Classics
#     Take the Stage in Windy City', 'WORK_OF_ART'), ('Leisure & Arts', 'ORG'),
#     ('Celimene', 'PERSON'), ('Kim Cattrall', 'PERSON'), ('Christina Haag', 'PERSON'),
#     ('plays Elianti', 'PERSON')]
