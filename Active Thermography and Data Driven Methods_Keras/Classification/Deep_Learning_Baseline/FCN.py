...
flist  = ['easy'] # ['informative'] # ['dataset'] # ['contact'] # ['Adiac']
for each in flist:
    fname = each
    ...
    # print(x_train.shape[1:], 'asdfasfd')
...
#    drop_out = Dropout(0.2)(conv2)
    ...
    filepath=fname+'/'+"model/weights-improvement-{epoch:02d}-{acc:.6f}-{val_acc:.6f}.hdf5"
    ...
    hist = model.fit(x_train, Y_train, batch_size=batch_size, nb_epoch=nb_epochs,
              verbose=1, validation_data=(x_test, Y_test), callbacks = [reduce_lr, checkpoint])
