...
# Put the following on top of main() funciton for calling it from command line
#@plac.annotations(
...
# add all dep to the parser labels
for text, annotations in TRAIN_DATA:
    for dep in annotations.get('deps', []):
        parser.add_label(dep)

# Train the model using minibatch for recognizing its own semantics
